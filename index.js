var WindshaftServer = require('./windshaftServer'),
...
var dbUser = process.env.MMW_DB_USER || 'mmw',
    dbPass = process.env.MMW_DB_PASSWORD || 'mmw',
    dbHost = process.env.MMW_DB_HOST || 'localhost',
    dbName = process.env.MMW_DB_NAME || 'mmw',
    dbPort = process.env.MMW_DB_PORT || 5432,
